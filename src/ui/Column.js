...
export const Column = (props) => {
  ...
  let lastColumn;
  if (
    props.column.columnId === props.columnOrder[props.columnOrder.length - 1]
  ) {
          ...
          >
            ...
            >
              <header className="card-header">
                ...
                <button
                  className="button is-small card-header-icon column-header-icon"
                  onClick={toggleCardModal}
                  data-tip="Add New Card"
                  data-delay-show='200'
                >
                  <span className="icon">
